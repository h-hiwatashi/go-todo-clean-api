...
public class GoCustomServerGenerator extends AbstractGoCodegen {
    ...
    private final Logger LOGGER = LoggerFactory.getLogger(GoCustomServerGenerator.class);
    ...
    public GoCustomServerGenerator() {
        super();
         ...
         */
        embeddedTemplateDir = templateDir = "go-custom-server";
